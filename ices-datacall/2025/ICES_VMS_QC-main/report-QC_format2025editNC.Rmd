...
CountryCode <- rb_getCodeList("ISO_3166")
GearType <- rb_getCodeList("GearType")
TargetAssemblage <- rb_getCodeList("TargetAssemblage")
VesselLength <- rb_getCodeList("VesselLengthClass")
icesRect <- rb_getCodeList("StatRec")
CountryCode <- rb_getCodeList("ISO_3166")
TargetAssemblage <- rb_getCodeList("TargetAssemblage")
VesselLength <- rb_getCodeList("VesselLengthClass")
VMSEnabled <- rb_getCodeList("YesNoFields")
```
