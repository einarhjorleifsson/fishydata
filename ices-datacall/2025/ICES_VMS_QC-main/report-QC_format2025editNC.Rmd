...
veDataPath <- file.path(getwd(), config$data_dir, paste0("ICES_VE_", country, ".csv"))
leDataPath <- file.path(getwd(), config$data_dir, paste0("ICES_LE_", country, ".csv"))
...
read_le <- function(file) {
  data <- read.csv(file,
                   ...
                   header = FALSE,  # LE files don't have headers
                   na.strings = "NULL") %>% 
    tidyr::as_tibble()
