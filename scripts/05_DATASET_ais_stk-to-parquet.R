# nohup R < scripts/05_DATASET_ais_stk-to-parquet.R --vanilla > scripts/log/05_DATASET_ais_stk-to-parquet_2026-01-12.log &
...
fao <-
  ...
  select(.fao = fao)
## CAFF area -------------------------------------------------------------------
fil <- "/home/haf/einarhj/stasi/gis/gisland_data/data-raw/misc/CAFF_Boundary_4326.zip"
...
## Highs seas and EEZ ----------------------------------------------------------
hs <-
  read_sf("/home/haf/einarhj/stasi/gis/eez/World_High_Seas_v1_20200826_gpkg/High_Seas_v1.gpkg") |>
  st_cast("POLYGON") |>
  mutate(id = 1:n()) |>
...
eez <-
  read_sf("/home/haf/einarhj/stasi/gis/eez/EEZ_land_union_v3_202003/EEZ_land_union_v3_202003/EEZ_Land_v3_202030.shp") |>
  janitor::clean_names() |>
...
for(y in 2025:2007) {
  ...
  trail |>
    ...
    arrange(mid, time) |>
    arrow::write_dataset("/u3/geo/fishydata/data/ais/stk-raw", format = "parquet",
