...
```
scripts/00_auxillary-data.R
scripts/01_vid-mid.R
scripts/02-1_logbooks-merge.R
scripts/02-2-logbooks-processing.R
scripts/02-3_logbooks-for-ais.R
scripts/04-stk-tails_parquet.R
```
