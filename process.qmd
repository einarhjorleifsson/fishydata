...
* Data recieved not marked by source (AIS or VMS)
  * Working on getting higher frequency and signal source
...
* Logbook data - daily feed
  * By **haul/setting** for larger vessels --> Jiggers 1 per fishing day
...
```{r}
knitr::include_graphics("~/stasi/lalina.png")
```
