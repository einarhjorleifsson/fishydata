...
Using the above we would only remove trip 5 (labelled "next departure before current arrival"). Before adopting this kind of algorithm it would though be of value to check other cases.
